...
class FirstRoomStep : ITutorialStep
{
    ...
    public FirstRoomStep(IDialogueService dialogueService, IOrderManager orderManager, Customer customer, SimpleDoor door, EmissionIndicator doorArrow, string dialogueName, string orderName)
    {
